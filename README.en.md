...
**Language Selection / 语言选择 / 言語:** [中文](README.md) | [English](#) | [日本語](README.ja.md)

Small web application allowing Honkai Star Rail fans to compare game characters with each other.

## How to setup development environment

I highly recommend using Node Version Manager (nvm), otherwise check `.nvmrc` and make sure your Node's version is matching it.

1. Install dependencies `npm install`
2. Start dev server `npm run dev`

A couple of words for those, who'd like to contribute!
